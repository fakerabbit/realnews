...
- (NSArray*)getAllSources {
    return @[@{kRNKeySourceTitle: @"Four Four Two",
             ...
             @{kRNKeySourceTitle: @"Tribal Football",
               kRNKeySourceUrl: @[@"http://rss.tribalfootball.com/pf/607843/www.tribalfootball.com/taxonomy/term/1950/all/feed"]},
             @{kRNKeySourceTitle: @"MARCA",
               kRNKeySourceUrl: @[@"http://marca.feedsportal.com/rss/en_football_real_madrid.xml"]},
...
- (NSArray*)getAllSpanishSources {
    return @[@{kRNKeySourceTitle: @"LaInformación",
             ...
             @{kRNKeySourceTitle: @"Liga BBVA",
               kRNKeySourceUrl: @[@"http://www.ligabbva.com/rss/1_portada/index.rss"]},
             @{kRNKeySourceTitle: @"AS",
               kRNKeySourceUrl: @[@"http://www.as.com/rss/feed.html?feedId=61"]},
             @{kRNKeySourceTitle: @"Marca",
               kRNKeySourceUrl: @[@"http://marca.feedsportal.com/rss/futbol_equipos_real_madrid.xml"]},
